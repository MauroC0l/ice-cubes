...
function MyNavbar({ handleLogoutWrapper, isAuth }) {
  ...
  return (
    <>
      {/* Navbar fissata in alto, riutilizzabile su tutte le pagine */}
      <Navbar expand="lg" className="custom-navbar">
        <Container fluid className="position-relative d-flex justify-content-between align-items-center">
          ...
          {/* Right side: Login/Logout button dinamico */}
          <Navbar.Text className="d-flex align-items-center gap-2">
            {isAuth ? (
              <Button variant="outline-light" onClick={handleLogoutWrapper}>
                Logout
              </Button>
            ) : (
